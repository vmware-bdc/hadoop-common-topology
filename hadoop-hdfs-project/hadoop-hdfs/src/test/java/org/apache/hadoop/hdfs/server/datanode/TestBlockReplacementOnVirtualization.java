...
public class TestBlockReplacementOnVirtualization extends TestCase {
  ...
  public void testBlockReplacement() throws IOException, TimeoutException {
    ...
    final String[] INITIAL_NODE_GROUPS = {"/NODE_GROUP0", "/NODE_GROUP1", "/NODE_GROUP2"};
    final String[] NEW_NODE_GROUPS = {"/NODE_GROUP2"};
    ...
    try {
      ...
      cluster.startDataNodes(CONF, 1, true, null, NEW_RACKS, NEW_NODE_GROUPS);
      cluster.waitActive();
      ...
      //current state: the newNode is on /RACK2/NODE_GROUP2, and "source" is the other dn on /RACK2/NODE_GROUP2.
